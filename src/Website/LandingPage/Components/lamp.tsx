...
export const LampContainer = ({
    ...
    return (
      <div
        className={`relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-900 w-full rounded-md z-0 ${className}`}
      >
        ...
        <div className="relative z-50 flex -translate-y-[500px] flex-col items-center px-5">
          {children}
        </div>
      </div>
    );
