...
import News from './newsletter.js';


const World = React.lazy(() => import('./globe.tsx').then((m) => ({ default: m.World })));
...
export function GlobeDemo() {
  const globeConfig = {
    ...
    ambientLight: "#38bdf8",
    directionalLeftLight: "#008080",
    directionalTopLight: "#008080",
    pointLight: "#008080",
    arcTime: 1000,
    arcLength: 0.9,
    rings: 1,
  ...
  const colors = ["#008080", "#40a4a8", "#4cb0a9"]; 
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
